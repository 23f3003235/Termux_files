...
# HTML UI - Fixed analytics JavaScript
html_content = """
<!DOCTYPE html>
<html>
<head>
            ...
            <div id="advancedAnalyticsSection" style="display: none;">
                <div class="advanced-filter-section">
                    ...
                    <div class="centered-form">
                        ...
                        <button onclick="loadAdvancedAnalytics()" style="max-width: 400px;">Generate Advanced Analytics</button>
                    </div>
                </div>
...
print("Fixed: Analytics endpoints now properly handle JSON responses")
