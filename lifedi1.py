...
class LifeTrackerHandler(SimpleHTTPRequestHandler):
    ...
    def handle_ai_chat(self):
        ...
        # DeepInfra API configuration - CORRECT ENDPOINT
        deepinfra_api_key = "WBgAzuUrqu20i6thQrFHs4xKAdPeJpwc"  # Replace with your key
        
        # Try these different endpoint formats:
        endpoints_to_try = [
            "https://api.deepinfra.com/v1/openai/chat/completions",  # OpenAI-compatible endpoint
            "https://api.deepinfra.com/v1/chat/completions",  # Alternative endpoint
        ]
        ...
        data = {
            "model": "microsoft/DialoGPT-medium",  # or other supported models
            "messages": [{"role": "user", "content": user_message}],
            "max_tokens": 100,
            "temperature": 0.7
        }

        reply = "No endpoints worked"
        ...
        for endpoint in endpoints_to_try:
            try:
                ...
                if response.status_code == 200:
                    ...
                    print(f"Endpoint {endpoint} returned 405 - trying next")
                    continue
                else:
