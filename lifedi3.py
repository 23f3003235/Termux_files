...
class LifeTrackerHandler(SimpleHTTPRequestHandler):
    ...
    def handle_ai_chat(self):
        ...
        user_message = form.getvalue("message") or "Hello"

        deepinfra_api_key = "WBgAzuUrqu20i6thQrFHs4xKAdPeJpwc"  # REPLACE THIS
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                reply = f"API returned {response.status_code}: {response.text}"
